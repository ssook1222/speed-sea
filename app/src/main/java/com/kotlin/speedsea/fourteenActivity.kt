...
class fourteenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        three.setOnClickListener {
            timerTask?.cancel()
            var intent = Intent(this, fifteenActivity::class.java)
        ...
        timerTask = timer(period = 10){
            ...
            if(sec==0){
                ...
                handler.postDelayed(Runnable {
                    Toast.makeText(
                        this@fourteenActivity,
                        "실패!",
                        Toast.LENGTH_SHORT
                    ).show()
                }, 0)
                var retry = Intent(this@fourteenActivity, thirteenActivity::class.java)
                startActivity(retry)
            }
        }
    }
    ...
    override fun onBackPressed() {
        val builder: android.app.AlertDialog.Builder = android.app.AlertDialog.Builder(this@fourteenActivity)
