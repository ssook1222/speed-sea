...
class sixteenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        one.setOnClickListener {
            timerTask?.cancel()
            var intent = Intent(this, seventeenActivity::class.java)
        ...
        timerTask = timer(period = 10){
            ...
            if(sec==0){
                ...
                handler.postDelayed(Runnable {
                    Toast.makeText(
                        this@sixteenActivity,
                        "실패!",
                        Toast.LENGTH_SHORT
                    ).show()
                }, 0)
                var retry = Intent(this@sixteenActivity, thirteenActivity::class.java)
                startActivity(retry)
            }
        }
    }
    override fun onBackPressed() {
        val builder: android.app.AlertDialog.Builder = android.app.AlertDialog.Builder(this@sixteenActivity)
